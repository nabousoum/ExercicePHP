    ...
    <div class="princ">
        ...
        <form action="controller.php" method="POST">
          ...
          <div class="text2">
              ...
              <div> <input class="exercice6_champs" type="text" required="required" name="a" value="<?php if(!isset($_SESSION['err']['a']) && isset($_SESSION['post']) ) echo  $_SESSION['post']['a']; else ''  ?>">
              ...
              <div><input class="exercice6_champs" type="text" required="required" name="b" value="<?php if(!isset($_SESSION['err']['b']) && isset($_SESSION['post']) ) echo  $_SESSION['post']['b']; else ''  ?>">
             ...
             <div> Veuillez saisir le nombre c :</div>
               <div><input class="exercice6_champs" type="text" required="required" name="c" value="<?php if(!isset($_SESSION['err']['c']) && isset($_SESSION['post']) ) echo  $_SESSION['post']['c']; else ''  ?>">
